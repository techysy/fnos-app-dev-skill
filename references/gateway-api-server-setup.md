...
```bash
# /home/<user>/.config/systemd/user/hermes-gateway.service.d/api-server.conf
[Service]
...
[
  {
    ...
    "items": [
      {"type": "text", "field": "gateway_url", "label": "Gateway 地址", "initValue": "http://<NAS_IP>:8642"},
